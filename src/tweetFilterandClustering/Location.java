 ...
 *  Modified by Nguyen Duc Duy - NICT Japan
 *************************************************************************/
...
public class Location { 
    ...
    // Manually set the longtitude
    public void setLongtitude(double val){
        this.longitude = val;
    }
    
    // Manually set the latitude
    public void setLatitude(double val){
        this.latitude = val;
    }
    
    // Manually set the long&lat
    public void setLongtitudeNLatitude(double longt, double lat){
        this.latitude = longt;
        this.longitude =  lat;
    } 
