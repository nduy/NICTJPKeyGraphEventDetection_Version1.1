...
public class KeywordHistogram {
    ...
    public Map<DateTime,Integer> lookupTable = new LinkedHashMap(); //[Dattime point, index in the histogram]
    DateTime tStart;
    DateTime tEnd;
    
    public KeywordHistogram(DateTime timeStart, DateTime timeEnd, int timeSlotSize){
        tStart = timeStart;
        tEnd = timeEnd;
    ...
    public KeywordHistogram(KeywordHistogram his){
  ...
  //          DateTimeFormatter ft = DateTimeFormat.forPattern("yyyy-m-d'T'HH:mm:ss.SSS'Z'"); 
    ...
    public static void main(String[] args) {
        ...
        KeywordHistogram myHis = new KeywordHistogram(sta, end, 30);
