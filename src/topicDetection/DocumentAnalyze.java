...
public class DocumentAnalyze {
	...
	public ArrayList<DocumentCluster> clusterbyKeyGraph(HashMap<String, Document> docs, HashMap<String, Double> DF) throws IOException {
...
//                                                    if (topicDetection.Main.enable_ST_cluster_restrict&&c.containsKey(str) && d.keywords.containsKey(str)) {
//                                                        cosineSimilarity = cosineSimilarity*2;
//                                                        break;
//                                                    }
						...
						if (cosineSimilarity > constants.DOC_SIM2KEYGRAPH_MIN) {
							...
							dc.similarities.put(d.id, cosineSimilarity);
                                                       // System.out.println(d.id + "\t " + cosineSimilarity);
						}
					}
        ...
        public ArrayList<DocumentCluster> extractClustersFromKeyCommunityNew(HashMap<String, Document> docs, ArrayList<HashMap<String, Node>> communities,
			HashMap<String, Double> DF, int docSize, HashMap<String, Node> graphNodes) {
	...
	public double cosineSimilarity(HashMap<String, Node> community, Document d2, HashMap<String, Double> DF, int docSize) {
		...
		if (numberOfKeywordsInCCommon > 1)
